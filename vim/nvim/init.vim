...
let g:config_table = [
            ...
            \ [ 'nvim-lua/popup.nvim', '', ['nvim']],
            \ [ 'nvim-telescope/telescope-media-files.nvim', '', ['nvim']],
            \ [ 'dhruvmanila/telescope-bookmarks.nvim', '', ['nvim']],
            \ [ 'FeiyouG/command_center.nvim', '', ['nvim']],
            \ [ 'nvim-telescope/telescope-file-browser.nvim', '', ['nvim']],
            \ [ 'sindrets/diffview.nvim', '', ['nvim']],
            \ [ 'paopaol/telescope-git-diffs.nvim', '', ['nvim']],
            \ [ 'fannheyward/telescope-coc.nvim', '', ['nvim']],
            \ [ 'MaximilianLloyd/adjacent.nvim', '', ['nvim']],
            \ [ '', 'zoom.vim'],
            \ [ '', 'custom.vim' ],
            \ [ '', 'keybinding.vim'],
            \ [ '', 'colorscheme.vim' ],
